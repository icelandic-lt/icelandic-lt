...
* [Software](#software): Tools, scripts, and software for data preprocessing and running the TTS pipeline on various platforms.
...
| Training code              | Description                                                                                                                                                                                                 | Location(s)                                                                                                                                                       |
|-----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Software                  | Description                                                                                                                                                                                                                                         | Location(s)                                                                                                                                                        |
|-----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Document reader           | Document reader web application that interfaces to a TTS service via the Internet.                                                                                                                                                                         | [GitHub](https://github.com/icelandic-lt/tts_webapp)<br>[CLARIN-IS](http://hdl.handle.net/20.500.12537/282)                                                          |
| Emotional Speech Scripts  | Audio dataset recording and preparation scripts, used for generation of the [Talrómur 3](https://repository.clarin.is/repository/xmlui/handle/20.500.12537/344) dataset                                                                              | [GitHub](https://github.com/icelandic-lt/emospeech-scripts)                                                                                                          |
| G2P-service               | Restful service for Sequitur and Fairseq G2P models.                                                                                                                                                                                                 | [GitHub](https://github.com/icelandic-lt/g2p-service)                                                                                                                |
| IceG2P                    | Grapheme-to-phoneme toolkit for Python. Uses G2P LSTM model.                                                                                                                                                                                         | [GitHub](https://github.com/icelandic-lt/ice-g2p)                                                                                                                    |
| LOBE                      | Recording client made specifically for TTS data. collections                                                                                                                                                                                          | [GitHub](https://github.com/icelandic-lt/LOBE)                                                                                                                       |
| Phrasing tool             | Tool for adding pauses in text for more natural speech.                                                                                                                                                                                              | [GitHub](https://github.com/icelandic-lt/phrasing-tool)                                                                                                              |
| Regína normalizer         | Text normalizer for TTS based on regular expressions.                                                                                                                                                                                                | [GitHub](https://github.com/icelandic-lt/regina_normalizer)                                                                                                          |
| Revoxx                    | A graphical recording application for recording raw speech and generating speech datasets.                                                                                                                                                           | [GitHub](https://github.com/icelandic-lt/revoxx)                                                                                                          |
| Símarómur                 | Icelandic TTS App for the Android TTS service. Available on [Google Play](https://play.google.com/store/apps/details?id=com.grammatek.simaromur).                                                                                                    | [GitHub](https://github.com/icelandic-lt/simaromur)<br>[Google Play](https://play.google.com/store/apps/details?id=com.grammatek.simaromur)                          |
| Text cleaner              | Text cleaning module for processing raw text input. This module is a component of a TTS-Frontend engine. It is the first step in processing raw text input before being normalized in the next step in the TTS-Frontend pipeline. | [GitHub](https://github.com/icelandic-lt/text-cleaner)                                                                                                               |
| Tiro-TTS                  | TTS RESTful service in Python for serving fastspeech2 voice models as well as Amazon Polly voices.                                                                                                                                                   | [GitHub](https://github.com/icelandic-lt/tiro-tts)<br>[CLARIN-IS](http://hdl.handle.net/20.500.12537/268)                                                            |
| TTS data preparation      | Module for preparing text data for TTS data collections, specifically for the Icelandic language.                                                                                                                                                    | [GitHub](https://github.com/icelandic-lt/tts_data)                                                                                                                   |
| TTS frontend API          | gRPC service definitions for the TTS frontend preprocessing pipeline.                                                                                                                                                                                 | [GitHub](https://github.com/icelandic-lt/tts-frontend-api)                                                                                                           |
| TTS frontend pipeline     | TTS text-processing pipeline for Icelandic. The pipeline includes modules for HTML parsing, text cleaning, text normalization for TTS, spell and grammar correction, phrasing, and grapheme-to-phoneme (G2P) conversion.                             | [GitHub](https://github.com/icelandic-lt/tts-frontend)<br>[CLARIN-IS](http://hdl.handle.net/20.500.12537/279)                                                        |
| TTS frontend service      | gRPC service for the TTS frontend pipeline for use in server environments as part of a network-based TTS system.                                                                                                                       | [GitHub](https://github.com/icelandic-lt/tts-frontend-service)                                                                                                       |
| WebRICE                   | Browser plugin that allows users to listen to text on web pages. It interfaces with a TTS service over the Internet.                                                                                                      | [GitHub](https://github.com/icelandic-lt/webrice-chrome-extension)<br>[CLARIN-IS](http://hdl.handle.net/20.500.12537/261)                                            |
