...
| Annotation Interface Instruct-tuning | This web application is designed for rating, ranking, and improving prompts and responses. It supports multiple languages and includes various evaluation tasks for both prompts and responses. | [GitHub](https://github.com/icelandic-lt/annotation_if_instruct_tuning) |
| Annotation Interface Sentiment | A web application for annotating Icelandic blog comments to help improve AI understanding of Icelandic language and culture for e.g. Sentiment analysis, Toxicity detection, Politeness, etc. | [GitHub](https://github.com/icelandic-lt/annotation_if_sentiment) |
